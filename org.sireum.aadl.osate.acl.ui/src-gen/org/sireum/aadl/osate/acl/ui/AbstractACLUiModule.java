...
/**
 * Manual modifications go to {org.sireum.aadl.osate.acl.ui.ACLUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractACLUiModule extends org.eclipse.xtext.ui.DefaultUiModule {
	
	public AbstractACLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(org.sireum.aadl.osate.acl.parser.antlr.lexer.InternalACLLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return org.sireum.aadl.osate.acl.ui.labeling.ACLLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(org.sireum.aadl.osate.acl.ui.labeling.ACLDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return org.sireum.aadl.osate.acl.ui.outline.ACLOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return org.sireum.aadl.osate.acl.ui.contentassist.antlr.ACLParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.ex.ca.ContentAssistParserGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(org.sireum.aadl.osate.acl.ui.contentassist.antlr.lexer.InternalACLLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(org.sireum.aadl.osate.acl.ui.contentassist.antlr.lexer.InternalACLLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.ex.ca.ContentAssistParserGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(org.sireum.aadl.osate.acl.ui.contentassist.antlr.lexer.InternalACLLexer.class);
	}
