		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComputationalModelAccess().getGroup_0_0(), "rule__ComputationalModel__Group_0_0__0");
					put(grammarAccess.getComputationalModelAccess().getGroup_1(), "rule__ComputationalModel__Group_1__0");
					put(grammarAccess.getComputationalModelAccess().getGroup_1_0(), "rule__ComputationalModel__Group_1_0__0");
					put(grammarAccess.getFlowsAccess().getGroup(), "rule__Flows__Group__0");
					put(grammarAccess.getContractsAccess().getGroup(), "rule__Contracts__Group__0");
					...
					put(grammarAccess.getComputationalModelAccess().getRelationshipsAssignment_1_0_3(), "rule__ComputationalModel__RelationshipsAssignment_1_0_3");
