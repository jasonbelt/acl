...
public class ACLParser extends AbstractPartialContentAssistParser {
	...
	@Override
	protected org.sireum.aadl.osate.acl.ui.contentassist.antlr.internal.InternalACLParser createParser() {
		org.sireum.aadl.osate.acl.ui.contentassist.antlr.internal.InternalACLParser result = new org.sireum.aadl.osate.acl.ui.contentassist.antlr.internal.InternalACLParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSpecSectionAccess().getAlternatives(), "rule__SpecSection__Alternatives");
					put(grammarAccess.getComputationalModelAccess().getAlternatives(), "rule__ComputationalModel__Alternatives");
					put(grammarAccess.getSpecStatementAccess().getAlternatives(), "rule__SpecStatement__Alternatives");
					put(grammarAccess.getImpliesExprAccess().getAlternatives_1_0_0_1(), "rule__ImpliesExpr__Alternatives_1_0_0_1");
					...
					put(grammarAccess.getAclSubclauseAccess().getGroup(), "rule__AclSubclause__Group__0");
					put(grammarAccess.getAclContractAccess().getGroup(), "rule__AclContract__Group__0");
					put(grammarAccess.getComputationalModelAccess().getGroup_0(), "rule__ComputationalModel__Group_0__0");
					put(grammarAccess.getComputationalModelAccess().getGroup_1(), "rule__ComputationalModel__Group_1__0");
					put(grammarAccess.getComputationalModelAccess().getGroup_1_3(), "rule__ComputationalModel__Group_1_3__0");
					put(grammarAccess.getComputationalModelAccess().getGroup_1_3_1(), "rule__ComputationalModel__Group_1_3_1__0");
					put(grammarAccess.getFlowsAccess().getGroup(), "rule__Flows__Group__0");
					...
					put(grammarAccess.getSpecStatementAccess().getGroup_0_2(), "rule__SpecStatement__Group_0_2__0");
					put(grammarAccess.getSpecStatementAccess().getGroup_0_6(), "rule__SpecStatement__Group_0_6__0");
					...
					put(grammarAccess.getAtomicExprAccess().getGroup(), "rule__AtomicExpr__Group__0");
					...
					put(grammarAccess.getAclSubclauseAccess().getContractAssignment_1(), "rule__AclSubclause__ContractAssignment_1");
					put(grammarAccess.getAclContractAccess().getSpecsAssignment_1(), "rule__AclContract__SpecsAssignment_1");
					put(grammarAccess.getComputationalModelAccess().getConstraintsAssignment_1_3_0(), "rule__ComputationalModel__ConstraintsAssignment_1_3_0");
					put(grammarAccess.getComputationalModelAccess().getConstraintsAssignment_1_3_1_1(), "rule__ComputationalModel__ConstraintsAssignment_1_3_1_1");
					put(grammarAccess.getFlowsAccess().getFlowsAssignment_1(), "rule__Flows__FlowsAssignment_1");
					put(grammarAccess.getFlowAccess().getFlowIdAssignment_0(), "rule__Flow__FlowIdAssignment_0");
					put(grammarAccess.getFlowAccess().getSrcPortsAssignment_2(), "rule__Flow__SrcPortsAssignment_2");
					put(grammarAccess.getFlowAccess().getSrcPortsAssignment_3_1(), "rule__Flow__SrcPortsAssignment_3_1");
					put(grammarAccess.getFlowAccess().getDstPortsAssignment_5(), "rule__Flow__DstPortsAssignment_5");
					put(grammarAccess.getFlowAccess().getDstPortsAssignment_6_1(), "rule__Flow__DstPortsAssignment_6_1");
					put(grammarAccess.getContractAccess().getSpecsAssignment_1(), "rule__Contract__SpecsAssignment_1");
					put(grammarAccess.getSpecStatementAccess().getForPortAssignment_0_2_1(), "rule__SpecStatement__ForPortAssignment_0_2_1");
					put(grammarAccess.getSpecStatementAccess().getAssumeTitleAssignment_0_3(), "rule__SpecStatement__AssumeTitleAssignment_0_3");
					put(grammarAccess.getSpecStatementAccess().getPredAssignment_0_5(), "rule__SpecStatement__PredAssignment_0_5");
					put(grammarAccess.getSpecStatementAccess().getTracesToAssignment_0_6_2(), "rule__SpecStatement__TracesToAssignment_0_6_2");
					put(grammarAccess.getSpecStatementAccess().getGuaranteeTitleAssignment_1_2(), "rule__SpecStatement__GuaranteeTitleAssignment_1_2");
					...
					put(grammarAccess.getAtomicExprAccess().getIdAssignment_1(), "rule__AtomicExpr__IdAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.sireum.aadl.osate.acl.ui.contentassist.antlr.internal.InternalACLParser typedParser = (org.sireum.aadl.osate.acl.ui.contentassist.antlr.internal.InternalACLParser) parser;
