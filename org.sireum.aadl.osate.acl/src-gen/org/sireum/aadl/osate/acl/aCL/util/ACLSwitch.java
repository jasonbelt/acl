...
public class ACLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        AclSubclause aclSubclause = (AclSubclause)theEObject;
        T result = caseAclSubclause(aclSubclause);
        if (result == null) result = caseAnnexSubclause(aclSubclause);
        if (result == null) result = caseModalElement(aclSubclause);
        if (result == null) result = caseNamedElement(aclSubclause);
        if (result == null) result = caseElement(aclSubclause);
      ...
      case ACLPackage.COMPUTATIONAL_MODEL:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Acl Subclause</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Acl Subclause</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAclSubclause(AclSubclause object)
  {
    return null;
  }
