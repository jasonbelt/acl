...
ruleAnnexSubclause returns [EObject current=null] 
    ...
    {
        $current = $this_AclSubclause_0.current;
...
entryRuleAclSubclause returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getAclSubclauseRule()); }
	 iv_ruleAclSubclause=ruleAclSubclause 
	 { $current=$iv_ruleAclSubclause.current; } 
	 EOF 
;

// Rule AclSubclause
ruleAclSubclause returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleAclContract returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getAclContractRule()); }
	 iv_ruleAclContract=ruleAclContract 
	 { $current=$iv_ruleAclContract.current; } 
	 EOF 
;

// Rule AclContract
ruleAclContract returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
    ...
    {
        $current = $this_Contracts_2.current;
        afterParserOrEnumRuleCall();
    }
)
;
...
// Entry rule entryRuleContracts
entryRuleContracts returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getContractsRule()); }
	 iv_ruleContracts=ruleContracts 
	 { $current=$iv_ruleContracts.current; } 
	 EOF 
;

// Rule Contracts
ruleContracts returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
